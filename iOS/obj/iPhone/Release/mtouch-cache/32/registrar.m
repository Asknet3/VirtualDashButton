...
void xamarin_create_classes () {
	...
	__xamarin_class_map [92].handle = objc_getClass ("UITextPosition");
	__xamarin_class_map [93].handle = objc_getClass ("UITextRange");
	__xamarin_class_map [94].handle = objc_getClass ("UITextSelectionRect");
	...
	__xamarin_class_map [111].handle = objc_getClass ("UIBarButtonItem");
	...
	__xamarin_class_map [134].handle = objc_getClass ("UIKit_UIActionSheet__UIActionSheetDelegate");
	__xamarin_class_map [135].handle = objc_getClass ("UIKit_UIAlertView__UIAlertViewDelegate");
	...
	__xamarin_class_map [140].handle = objc_getClass ("__UIRotationGestureRecognizer");
	...
	__xamarin_class_map [145].handle = objc_getClass ("__UISwipeGestureRecognizer");
	__xamarin_class_map [146].handle = objc_getClass ("__UIScreenEdgePanGestureRecognizer");
	...
	__xamarin_class_map [154].handle = objc_getClass ("UIKit_UITabBarController__UITabBarControllerDelegate");
	...
	__xamarin_class_map [157].handle = [TestFairy class];
