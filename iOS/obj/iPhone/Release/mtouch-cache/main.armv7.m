...
extern void *mono_aot_module_CarouselPageNavigationiOS_info;
...
extern void *mono_aot_module_CarouselPageNavigation_info;
...
{
	mono_aot_register_module (mono_aot_module_CarouselPageNavigationiOS_info);
	...
	mono_aot_register_module (mono_aot_module_CarouselPageNavigation_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "CarouselPageNavigationiOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
